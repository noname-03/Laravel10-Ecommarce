                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $.each(response.data.data, function(index, product) {
                            ...
                            productsHtml += '<a href="{{ route('admin.product.index') }}/' +
                                product
                                .id +
                                '/edit" class="btn btn-success btn-xs waves-effect waves-light"><i class="mdi mdi-pencil"></i></a>';
                            ...
                            productsHtml +=
                                '<button type="submit" onclick="return confirm(\'Apakah Anda Yakin Ingin Menghapus Data Ini?\')" class="btn btn-danger btn-xs waves-effect waves-light"><i class="mdi mdi-close"></i></button>';
                            productsHtml += '</form>';
                            productsHtml += '</div>';
                            productsHtml += '<div class="bg-light">';
                            productsHtml += '<img src="{{ asset('images/product/') }}/' +
                                product.photo +
                            ...
                            productsHtml +=
                                '<h5 class="font-16 mt-0 sp-line-1"><a href="{{ route('admin.product.show', '') }}/' +
                                product.id +
                                '" class="text-dark">' + product.title + '</a></h5>';
                            productsHtml +=
                                '<h5 class="m-0"> <span class="text-muted"> Stocks : ' + product
                                .qty +
                                ' pcs</span></h5>';
                            productsHtml += '</div>';
