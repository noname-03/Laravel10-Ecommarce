...
<head>
    ...
    <title>Invoice receipt Eshop Fahrurrozi</title>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="invoice-wrapper">
                        {{-- <div class="intro">
						Hi <strong>{{$transaction->user->name}}</strong>,
						<br>
                            ...
                            <div class="row">
                                ...
                                <div class="col-6 col-md-4">
                                    <a class="site-logo" href="/"><img
                                            src="{{ asset('user') }}/assets/corporate/img/logos/logo-shop-red.png"
                        ...
                        <div class="line-items">
                            ...
                            @php
                                $sub = 0;
                            @endphp
                            @foreach ($transaction->detailTransactions as $data)
                                <div class="items">
                                    <div class="row item">
                        ...
                        <div class="total text-right">
                            ...
                            <div class="field">
                                Subtotal <span>@currency($sub)</span>
                            </div>
                            <div class="field">
                                Shipping <span>@currency(15000)</span>
                            </div>
                            {{-- <div class="field">
								Discount <span>4.5%</span>
							</div> --}}
                            <div class="field grand-total">
                                Total <span>@currency($sub + 15000)</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="footer">
                    Copyright © 2023. Shop Now
                </div>
                <div class="print">
                    <a href="#" onclick="javascript:window.print()" style="marging auto; width:100%;">
