                            ...
                            <div class="col-md-4 col-sm-6 col-xs-12">
                                <div class="product-item">
                                    <div class="pi-img-wrapper">
                                        <img src="{{ asset('images') }}/{{ $data->photo }}" class="img-responsive"
                                            alt="{{ asset('images') }}/{{ $data->photo }}">
                                        <div>
                                            <a href="{{ asset('images') }}/{{ $data->photo }}"
                                                class="btn btn-default fancybox-button">Zoom</a>
                                            {{-- <a href="#product-pop-up" class="btn btn-default fancybox-fast-view">View</a> --}}
                                        </div>
                                    </div>
                                    <h3><a
                                            href="{{ route('eshop.show.product', ['id' => $data->name]) }}">{{ $data->name }}</a>
                                    </h3>
                                    <div class="pi-price">@currency($data->price)</div>
                                    <form action="{{ route('cart.store') }}" method="POST" id="demo-form2"
                                        ...
                                        <button href="{{ route('cart.store') }}" class="btn btn-default add2cart">Add to
                                            cart</button>
                                    </form>
